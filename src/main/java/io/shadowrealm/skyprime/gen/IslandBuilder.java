...
public class IslandBuilder implements Listener
{
	...
	private World createHell(Island is, Location mainSpawn)
	{
		stream.sendTitle("", C.AQUA + "" + C.BOLD + "Generating Hell: " + C.RESET + C.GRAY + F.pc(0.07, 0), 0, 500, 20);
		WorldCreator wc = new WorldCreator(SkyMaster.worldName(island) + "/hell");
